...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--public", action="store_true", help="Mark metadata as public after the real Galaxy history has been made public")
    parser.add_argument("--importable", action="store_true", help="Mark metadata as importable after the real Galaxy history has been made importable")
